...
| **Pipeline** | Highly pipelined: rasterizer → TMU (32-stage) → pixel shader (9-stage) → depth buffer (5-stage) → framebuffer (4-stage), valid/ready handshaking with inter-stage FIFOs |
