...
| **Pipeline** | Highly pipelined: rasterizer → TMU (32-stage) → pixel shader (9-stage) → depth buffer (3-stage) → framebuffer (3-stage), valid/ready handshaking with inter-stage FIFOs |
...
| **Code size** | ~22,000 lines, 24 RTL modules |
